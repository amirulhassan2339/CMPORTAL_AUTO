...
public class SD_TransitionOfCareForm {
	...
	public void i_select_formType(String FormType) {
		...
		String xpath='//ul[@id="formTypeId_listbox"]//li[text()="'+FormType+'"]'
		obj.selectdropdown(frame,xpath)
	}
	...
	public void ClickAnalyticsApply() {
		...
		WebUI.click(findTestObject('Object Repository/OR_PatientGrid/OR_PatientData/OR_NonClinicalSection/OR_CarePlan/Notes/Forms/TransitionOfCareForm/Courtesy Calls/Obj_ApplyBtn_Analytics'))
				 ...
				 Thread.sleep(2000)
				 'click on arrow'
				 WebUI.waitForElementPresent(findTestObject('Object Repository/OR_OpenPatient/clickArrow2'), 0)
				 WebUI.click(findTestObject('Object Repository/OR_OpenPatient/clickArrow2'))
				 ...
				 Thread.sleep(2000)
				 WebUI.sendKeys(findTestObject('Object Repository/OR_OpenPatient/inputPatient'),"Dermo505, Mac505")
