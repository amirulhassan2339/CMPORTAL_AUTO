...
class SD_Schedule {
	...
	public void I_should_see_patient_ExcelData() {
		...
		String actual_PatientName1 = WebUI.getText(findTestObject('Object Repository/OR_PatientGrid/Schedule/Obj_VerifyPatientName'))
		WebUI.verifyEqual(actual_PatientName1, findTestData('DF_CMRData/TD_SUI').getValue(2, 1))
	...
	public void Login() {
		...
		String Email = "au1@slt.com"
		String Password = "Amir123"
	...
	public void appointmentData() {
		...
		//		WebUI.verifyEqual(actualProvider, "User, Automation")
		//
		//
