...
#		   * I click on based on patient medical record
		...
		Examples: 
			...
			| Dermo505, Mac505 | Back pain | Audio only over the telephone | 99443 | Telehealth utilizing audio/video | 99203 | Yes          | Diabetes   | 0.99-0.90   | 0.89-0.60    | Z13.6         | Support Test Ent    | In no acute distress | EntMerging505 | Signed      | Addendum Test |
